    ...
    artwork.detectedKind === "pdf"
      ...
      : artwork.detectedKind === "ai_unsupported"
        ? {
            ...
            finishedSize: { value: null, confidence: "low" as const, source: "ai_scan" },
            finishedSizeSource: { value: null, confidence: "low" as const, source: "ai_scan" },
            bleedAllowanceMm: { value: null, confidence: "low" as const, source: "ai_scan" },
